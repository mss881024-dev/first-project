...
# 하단: 핵심 포인트 3개
points = [
    ("Renewal 전사 동결", "4개사 모두 기존 인원 갱신 단가·금액을\n전년과 동일하게 동결 (증감 0%)"),
    ("증가분 = 100% True-up", "증가액 1.1억원은 전액 신규 인원 정산분.\n계약 단가 인상 요인은 없음"),
    ("사업 성장의 반영", "동아에스티(+168명)·에스티젠바이오(+214명)의\n사업 확장에 따른 사용 규모 확대"),
]
...
rows = [
    ...
    [("동아에스티㈜", {"align": C}), "494,797,800",
     ...
     ("+9.0%", {"align": C, "bold": True, "color": ORANGE}),
...
add_text(s, Inches(0.85), Inches(5.68), Inches(11.6), Inches(0.95),
         [("핵심 요약", 12, True, NAVY),
          ("· 4개사 모두 Renewal(기존 인원)은 전년 금액 그대로 동결되었으며, 증가액 111,676,600원은 전액 25년 True-up 404명(에스티 168 · 제약 22 · 에스티젠 214)의 신규 정산분입니다.",
...
companies = [
    dict(
        ...
        reasons=[
            "25년 신규 True-up 인원이 없어 26Y 금액은 전년과 동일하게 동결됩니다.",
            "Renewal 88명 및 기존 True-up 4명(24년)의 계약 조건이 그대로 유지됩니다.",
            "3년 차 갱신에도 단가 인상 없이 안정적인 IT 예산 운영이 가능합니다.",
        ],
    ),
    dict(
        no="05", name="동아에스티㈜", page=7, rate="+9.0%", rate_color=ORANGE,
        badge="사업 확장 반영",
        ...
        total=("1,249EA → 1,341EA", "494,797,800", "539,788,200", "+9.0%"),
        reasons=[
            "Renewal 1,103명 금액은 전년과 동일하게 전액 동결되었습니다.",
            "증가분 44,990,400원은 전액 25년 True-up 168명의 신규 정산분으로, 임직원 증가 등 사업 확장에 따른 사용 규모 확대를 반영합니다.",
            "26Y 기준 총 1,341EA로 확대되어, 전사 표준 협업 환경이 성장 조직 전체에 일관되게 적용됩니다.",
        ],
    ),
    dict(
        ...
        reasons=[
            "Renewal 576명 금액은 전년과 동일하게 전액 동결되었습니다.",
            "증가분 7,172,200원은 25년 True-up 22명의 신규 정산분으로, 실사용 증가분만 반영된 최소 수준의 조정입니다.",
            "26Y 기준 총 709EA로, 전년 대비 2.6%의 안정적인 증가율을 유지합니다.",
        ],
    ),
    dict(
        ...
        reasons=[
            "Renewal 148명 금액은 전년과 동일하게 전액 동결되었습니다.",
            "증가분 59,514,000원은 전액 25년 True-up 214명의 신규 정산분입니다. 사업 확장에 따른 대규모 인력 확충이 그대로 반영된 결과로, 조직 성장을 보여주는 지표입니다.",
            "26Y 기준 총 430EA로 전년 대비 43% 이상 규모가 확대되어, 성장 단계에 맞는 표준화된 업무 환경 확보가 더욱 중요해졌습니다.",
        ],
    ),
]
...
add_text(s, Inches(1.0), Inches(3.7), Inches(11.3), Inches(2.0),
         [("동아그룹 4개사의 안정적인 Microsoft 업무 환경과 사업 성장을 계속 지원하겠습니다.",
           15, False, RGBColor(0xBD, 0xD7, 0xEE)),
