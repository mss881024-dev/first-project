...
header(s, "01  |  EXECUTIVE SUMMARY",
       "26Y 총 계약 1,317백만 원(+3.9%) — EA 증가분이 기타 라이선스 절감으로 상쇄됩니다", 3,
       title_size=18)
...
msgs = [
    ...
    ("최적화로 증가 상쇄", "Copilot 실사용 조정·Easy Tree 종료로 62,760,600원이 절감되어 총 증가율은 +3.9%입니다"),
]
mx2 = Inches(7.5)
...
header(s, "03  |  GROUP SUMMARY",
       "4사 합계는 +3.9%이며, 회사별 증감률은 -39.8%~+33.7%로 상이합니다", 5,
       title_size=17)
rows = [
    ["회사", "25Y", "26Y", "증감액", "증감률"],
...
stat_band(s, MX, Inches(5.35), CW, [
    ...
    ("증감 없음 사유", "서버 수량 변동 없음", NAVY, "4사 서버·인프라 규모가 늘지 않아 단가·수량 모두 동일"),
], big=18, band_h=Inches(1.0))
...
companies = [
    dict(
        ...
        title="동아쏘시오홀딩스 -39.8% — Copilot·Easy Tree 종료로 연 28,148,400원이 감소합니다",
    ...
    dict(
        ...
        title="동아에스티 +4.3% — True-up 92EA 증가분이 Copilot 실사용 조정으로 상당 부분 상쇄됩니다",
        ...
        note="EA 증가액 44,990,400원(True-up 92EA)이 Copilot 조정 절감액 -17,047,800원(42→9 Copy)으로 상당 부분 상쇄되어 총 증가율은 +4.3%입니다. ※ 전체계는 단수 조정(-4,860원) 반영 금액",
    ),
    dict(
