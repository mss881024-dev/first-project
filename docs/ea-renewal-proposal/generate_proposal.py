...
header(s, "03  |  GROUP SUMMARY",
       "4사 합계 +3.9% — 성장 투자(에스티젠·에스티)와 비용 절감(쏘시오·제약)이 균형을 이룹니다", 5,
       title_size=17)
rows = [
    ["회사", "25Y", "26Y", "증감액", "증감률"],
...
stat_band(s, MX, Inches(5.5), CW, [
    ...
    ("Copilot 운영 원칙", "실사용 기준", ORANGE, "활용도 검증 후 필요 수량만 유지 (105 → 15 Copy)"),
    ("절감분의 활용", "성장 재원", NAVY, "True-up 증가분의 56%를 자체 상쇄"),
...
companies = [
    ...
    dict(
        ...
        title="에스티젠바이오 +33.7% — 사업 확장(+130EA)이 만든 성장의 지표입니다",
...
tu = [("True-up 순증", "+111,676,600", "에스티젠 130 · 에스티 92 · 제약 22 (+244EA)", ORANGE),
      ("Copilot 조정", "-47,010,600", "105 → 15 Copy · 실사용 기준 재산정", NAVY),
